...
namespace ParameterIO
{
    public class AMLParameterObject
    {
        ...
        [XmlElement("BatchInputs")]
        public List<AMLParam> listBatchInputs = new List<AMLParam>();

        [XmlElement("BatchOutputs")]
        public List<AMLParam> listBatchOutputs = new List<AMLParam>();
        ...
        public string ReadSwagger()
        {
            try
            {
                ...
                string basicLink = Url.Substring(0, Url.IndexOf("/jobs?"));

                return ReadSwagger(basicLink);
            }
            catch (Exception)
            {
                return "Read Document Error. Please check Post URL !!!";
            }
        }
        ...
        public string ReadSwagger(string basiclink)
        {
            this.listInputParameter.Clear();
            this.listOutputParameter.Clear();
            this.listGlobalParameter.Clear();
            try
            {
                ...
                string jsonString = "";
                jsonString = wc.DownloadString(string.Format("{0}/swagger.json", basiclink));
                ...
                */
                ...
                //"definitions.BatchOutputs"
                listBatchOutputs = ParseMLParmeter(jsonString, "definitions.BatchOutputs");

                //"definitions.BatchInputs"
                listBatchInputs = ParseMLParmeter(jsonString, "definitions.BatchInputs");
        ...
        public bool ImportInputParameter(string InputPath)
        {
            ...
            try
            {
                ...
                this.listBatchInputs = amlObj.listBatchInputs;
                this.listBatchOutputs = amlObj.listBatchOutputs;
