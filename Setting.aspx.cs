...
namespace AzureML_BES_Web_Template
{
    public partial class Setting : System.Web.UI.Page
    {
        ...
        private void ResetParameter()
        {
            ...
            paramObj.APIKey = Crypto.EncryptStringAES((txtAPI.Text).Trim());
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                // Load editing of globle Parameter
                ...
                */
                if (paramObj.listBatchOutputs != null && paramObj.listBatchOutputs.Count > 0)
                {
                    for (int i = 0; i < paramObj.listBatchOutputs.Count; i++)
                    {
                        var param = paramObj.listBatchOutputs[i];
                        param.Alias = ((TextBox)FindControl(string.Format("output{0}_alias_{1}", i, outputPost))).Text;
                        //param.Enable = ((CheckBox)FindControl(string.Format("output{0}_enable_{1}", i, outputPost))).Checked;
                    }
                }
        ...
        private void GenerateParameterList()
        {
            ...
            if(paramObj.listGlobalParameter!=null && paramObj.listGlobalParameter.Count > 0) GenerateGlobalParameterList();

            if (paramObj.listBatchOutputs != null && paramObj.listBatchOutputs.Count > 0) GenerateBatchOutputList();
        ...
        private void GenarateInformation()
        {
            ...
            parameterRegion.Controls.Add(new LiteralControl("<p class=\"titleresult\">App Title and Description</p>"));
        ...
        private void GenerateBatchOutputList()
        {
            //parameterRegion.Controls.Clear();
            parameterRegion.Controls.Add(new LiteralControl("<p class=\"titleresult\">Batch Outputs</p>"));
            parameterRegion.Controls.Add(new LiteralControl("<table class=\"table table-hover table-bordered\">"));
            parameterRegion.Controls.Add(new LiteralControl("<tr class=\"info\"><th style=\"width:5%\">#</th><th style=\"width:20%\">Name</th><th>Alias</th></tr>"));
        ...
        {
            //parameterRegion.Controls.Clear();
            parameterRegion.Controls.Add(new LiteralControl("<p class=\"titleresult\">Output Parameters</p>"));
            parameterRegion.Controls.Add(new LiteralControl("<table class=\"table table-hover table-bordered\">"));
        ...
        {
            //parameterRegion.Controls.Clear();
            parameterRegion.Controls.Add(new LiteralControl("<p class=\"titleresult\">Global Parameters</p>"));
            parameterRegion.Controls.Add(new LiteralControl("<table class=\"table table-hover table-bordered\">"));
        ...
        {
            //parameterRegion.Controls.Clear();
            parameterRegion.Controls.Add(new LiteralControl("<p class=\"titleresult\">Input Parameters</p>"));
            parameterRegion.Controls.Add(new LiteralControl("<table class=\"table table-hover table-bordered\">"));
            parameterRegion.Controls.Add(new LiteralControl("<tr class=\"info\"><th>#</th><th>Name</th><th>Type</th><th>Alias</th><th>Description</th><th>Default</th><th>Min</th><th>Max</th></tr>"));
        ...
        protected void btnSubmitKey_Click(object sender, EventArgs e)
        {
            ...
            if (keyinput == Crypto.DecryptStringAES(paramObj.APIKey))
            {
                //if (!Page.IsPostBack)
                {
